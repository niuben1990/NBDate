...
-(void)handleTapGesture:(UIGestureRecognizer*)gestureRecognizer{
    ...
    if (CGRectContainsPoint(_scrollView.bounds, locationInScrollView)) {
        ...
        if ([self.delegate respondsToSelector:@selector(flowView:didTapPageAtIndex:getsure:)]) {
            [self.delegate flowView:self didTapPageAtIndex:tappedIndex getsure:gestureRecognizer];
        }
    }
}
